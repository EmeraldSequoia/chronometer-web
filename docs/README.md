...
- [**Time Controller**](time-controller.md) — The unit-first transport panel: unit chips, the one ◀ ▶ pair (tap to step, hold to scrub), rise / set / transit for any body, `tu` / `tb` persistence, the CC2 footprint
